...
\begin{frame}{Solution}
  ...
  \begin{tikzpicture}
    ...
    \node<2->[align=left,anchor=east,red,font={\scshape\ttfamily}] at (arrow.west) {
      ...
      cctccacgcc aacggagcct cattcttctt\\
      cctccactcc aacggagcct caggtgtctt};
    \node<1->[anchor=west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.5\textwidth,trim={0 0 7cm 0},clip]{Bayesian-Rallus.png}};
...
\begin{frame}{Example 1: Austronesian}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \includegraphics[width=\textwidth,page=2,trim={2cm 4cm 1cm 5cm},clip]{pulsesandpauses.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=0.6\textwidth,page=3,trim={1cm 1cm 7.5cm 16cm},clip]{pulsesandpauses.pdf}
    \end{column}
  \end{columns}
\end{frame}
