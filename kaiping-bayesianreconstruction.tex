...
\begin{frame}{Solution}
  ...
  \end{tikzpicture}
  \footnotetext{\textcite{garcia2015trans}}
\end{frame}
\subsection{Bayesian …}
...
\begin{frame}{Going back from data}
  ...
  should I believe in (and how much)?
...
\begin{frame}{Bayes' Theorem}
  ...
  \begin{columns}
    ...
    \end{column}
  \end{columns}
  \footnotetext{\textcite{dunn2015language,dunn2009contact,michael2015bayesian}}
\end{frame}
...
\begin{frame}{Example 1: Austronesian}
  \begin{columns}
    ...
    \end{column}
    \footnotetext{\textcite{gray2009language}}
    \begin{column}{0.5\textwidth}
...
\begin{frame}{Example 2: Bantu}
  \begin{columns}
    ...
    \end{column}
  \end{columns}
    \footnotetext{\textcite{bastin1999continuity}}
\end{frame}
\begin{frame}{Example 2: Bantu}
  \begin{columns}
    \begin{column}{0.5\textwidth}
    ...
    \end{column}
  \end{columns}
  \footnotetext{\textcite{currie2013cultural}}
\end{frame}
...
\begin{frame}{Example 3: Indo-European}
  \begin{columns}
    ...
    \end{column}
  \footnotetext{\textcite{chang2015ancestryconstrained}}
    \begin{column}{0.5\textwidth}
